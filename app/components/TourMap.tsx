...
const MapIframe = dynamic(
  () => Promise.resolve(({ mapUrl, tourTitle, locationName }: { mapUrl?: string; tourTitle: string; locationName: string }) => (
...
export default function TourMap({ mapUrl, tourTitle, locationName }: { mapUrl?: string; tourTitle: string; locationName: string }) {
